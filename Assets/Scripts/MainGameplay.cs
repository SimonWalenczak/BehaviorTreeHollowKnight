...
/// <summary>
/// Manages the boss's main gameplay by defining its behaviour tree.
/// Uses a BehaviorTree to orchestrate the different attack phases and the transitions between them depending on the boss's state.
/// </summary>
public class MainGameplay : MonoBehaviour
{
    ...
    /// <summary>
    /// Add the logic of the boss's behavior with his phases
    /// </summary>
    ...
    TreeNode SequenceIntro()
    {
        ...
        jump.shakeCameraOnLanding = true;
        sequence.Add(jump);
        sequence.Add(new Log { Text = "Intro Finished !" });
        return sequence;
    }
    ...
    {
        Sequence sequence = new Sequence();
        sequence.Add(new Log { Text = "Starting phase 1 !" });
    ...
    TreeNode SequenceAllPhase1()
    {
        ...
        sequence.Add(new Log { Text = "Sequence 1 Finished" });
        return sequence;
    }
